...
CREATE TABLE Keyword (
	...
	K_KEYWORD1	VARCHAR2(500)	NULL,
	K_KEYWORD2	VARCHAR2(500)	NULL,
	K_KEYWORD3	VARCHAR2(500)	NULL
);
...
CREATE TABLE ProductComment (
	P_RE_ID	NUMBER	NOT NULL,
	P_ID	NUMBER	NOT NULL,
	M_ID	VARCHAR2(500)	NOT NULL,
	P_RE_COMMENT	VARCHAR2(4000)	NULL,
	P_REF	NUMBER	NULL,
	P_RE_STEP	NUMBER	NULL,
	P_RE_LEVEL	NUMBER	NULL,
	P_RE_ADDDATE	DATE DEFAULT SYSDATE	NULL
);
...
ALTER TABLE ProductComment ADD CONSTRAINT PK_PRODUCTCOMMENT PRIMARY KEY (
	P_RE_ID
);
...
-- Member table
-- Manager
insert into Member values('MasterPotato1', 1, 'Potato123', 'master', 'master', '2020-11-01', 'M', '서울', 0, '2020-11-01', 'master', 0, 0, null, 'O', '2020-11-01', 0, '000-0000-0000', 'nothing1360@gmail.com', 'x', 'M', 'MY');
