 ...
 */
@WebServlet("/ProductCategoryCtl.do")
public class ProductCategoryCtl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int bCount = pservice.getCategoryByPageCount(c_lid);
		...
		request.setAttribute("c_lid", c_lid);
		...
		RequestDispatcher disp = request.getRequestDispatcher("ProductCategorylist.jsp");
