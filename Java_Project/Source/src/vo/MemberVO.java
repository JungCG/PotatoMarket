...
public class MemberVO {
	...
	public int getM_sellamount() {
		return m_sellamount;
	}
	public void setM_sellamount(int m_sellamount) {
		this.m_sellamount = m_sellamount;
	}
	...
	public char getM_authorizaion() {
		return m_authorizaion;
	}
	public void setM_authorizaion(char m_authorizaion) {
		this.m_authorizaion = m_authorizaion;
	}
