      ...
      <table>
         ...
         <tr>
            ...
            <td style="text-align: center;">
               1번 이미지 수정 : <input type="file" name="filename1" id="filename1"><br/>
               2번 이미지 수정 : <input type="file" name="filename2" id="filename2"><br/>
               3번 이미지 수정 : <input type="file" name="filename3" id="filename3">
            </td>
         </tr>
         <tr>
         ...
         <tr>
            <td colspan="2" style="text-align: center;">
            <button class="ICR_writeBtn" type="button" id="ICR_WriteBtn" onclick="goWrite();">수정완료</button>
...
Copyright © Potato-Market. All Rights Reserved.</div>
   ...
   <script>
    function goWrite(){
       ...
       var imgpre1 = document.getElementById("imgpre1");
       var imgpre2 = document.getElementById("imgpre2");
       var imgpre3 = document.getElementById("imgpre3");
       ...
       if(PwriteFrm.p_name.value==""){
          ...
          PwriteFrm.c_lid.options[0].focus();
            return false;
       }else if((PwriteFrm.filename1.value=="" && imgpre1.value=="") || 
             (PwriteFrm.filename2.value=="" && imgpre2.value=="") || 
             (PwriteFrm.filename3.value=="" && imgpre3.value=="")){
