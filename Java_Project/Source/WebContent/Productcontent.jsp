...
<%
   ...
   <%
       ...
       session.setAttribute("ShowUserID", request.getAttribute("write_m_id"));
    %>
<!DOCTYPE html>
<html>
...
Copyright © Potato-Market. All Rights Reserved.</div>
   ...
   if(userID != null && !userID.isEmpty()){   //로그인시
      String write_m_id = (String) request.getAttribute("write_m_id");
      if(userID.equals(write_m_id)){   //글 작성자와 로그인 사용자가 같은 경우 (수정,삭제 보이기)
