		...
		$("document").ready(function() {
			...
			$(window).scroll(function(){
				if($(window).scrollTop() != 0){
					...
					document.getElementById("JWJmaintitle").style.display = "none";
					$('.jck_everything').css('height', '100vh');
					$('.jck_menu_container').css('top', '0');
					$('.jck_content_container').css('margin-top', '30vh');
				}else{
					document.getElementById("JWJmaintitle").style.display = "block";
					document.getElementById("JWJhistorylist").style.display = "none";
					$('.jck_everything').css('height', '70vh');
					$('.jck_menu_container').css('top', '30vh');
					$('.jck_content_container').css('margin-top', '10vh');
				}
			});
		});
...
<body>
		...
		<a href=""><img src="./images/logo_img.png"></a>
	</div>
